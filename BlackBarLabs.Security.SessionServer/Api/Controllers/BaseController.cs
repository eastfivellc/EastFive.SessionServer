...
namespace BlackBarLabs.Security.SessionServer.Api.Controllers
{
    public class BaseController : BlackBarLabs.Api.Controllers.BaseController
    {
        ...
        private ConfigurationServiceDictionary ConfigurationServiceDictionary
        {
            get
            {
                return configurationServiceDictionary ?? (configurationServiceDictionary = 
                    (ConfigurationServiceDictionary)GlobalConfiguration.Configuration.Properties[SessionServer.API.Constants.SystemConfiguration.ConfigurationService]);
            }
        }
